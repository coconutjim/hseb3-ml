...
maximC = log10(200)
steps_count = 35
plot_stat(tr_data, tr_labels, te_data, te_labels, 'linear', minimC, maximC, steps_count)

# Task 3
c = find_optimal_c(tr_data, tr_labels, te_data, te_labels, 'linear', minimC, maximC, steps_count)
plot_support(tr_data, tr_labels, te_data, te_labels, 'linear', 1e-3)
plot_support(tr_data, tr_labels, te_data, te_labels, 'linear', c)
plot_support(tr_data, tr_labels, te_data, te_labels, 'linear', 1e4)